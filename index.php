...
<html lang="en">
  <head>
    ...
    <title>Mahidotify :: Systeme de notification</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
      <a class="navbar-brand" href="#">Mahidotify:: Systeme de notification</a>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a style ="
                ...
                if($i['type']=='comment'){
                    echo "Quelqu'un a commenté ton post.";
                }else if($i['type']=='like'){
                    echo ucfirst($i['name'])." aime ton post.";
                }
    ...
    <main role="main" class="container">
      ...
      <div class="starter-template">
        <h1>Bienvenue dans ce petit système de notification : Mahidotify</h1>
        <p class="lead">Ceci est juste un petit système de notification fait en php et mysql, il va te servir de pivot si tu retrouve des difficultés dans le codage d'un tel système. PS : Il est simple et le code est propre.</p>
      </div>
